...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
			<div class="box_wrapper"><center><h1 style="color:#3c40c6;">Audi TT</h1></center></div>
				
				
				    <table border="0">
					  <tbody>
						<tr>
						  <td><img src="images-2/TT.jpg" alt="" style ="width: 310px; height: 160px;" ></td>
						  <td><img src="images-2/TT_back.jpg" alt="" style ="width: 310px; height: 160px;" ></td>
						  <td><img src="images-2/TT_intr.jpg" alt="" style ="width: 310px; height: 160px;" ></td>
						  <td><img src="images-2/TT_intr-2.jpg" alt="" style ="width: 310px; height: 160px;" ></td>
						</tr>
					  </tbody>
					</table>
					...
					<h3>Details</h3>
                              ...
                              <?php
								...
								$sql = "SELECT * FROM car where model = '85'";
